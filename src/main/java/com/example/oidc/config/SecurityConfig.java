...
public class SecurityConfig {
    ...
    public OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> tokenResponseClient() {
        return request -> {
            System.out.println("CODE: " + request.getAuthorizationExchange().getAuthorizationResponse().getCode());
            System.out.println("Client ID: " + request.getClientRegistration().getClientId());
        ...
        return (authorities) -> {
            ...
            authorities.forEach((authority) -> {
                ...
                if (authority instanceof OidcUserAuthority userAuthority) {
                    ...
                    System.out.println(userAuthority.getUserInfo());
